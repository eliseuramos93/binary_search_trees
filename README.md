...
4. Write an `#insert` and `#delete` method which accepts a value to insert/delete (you’ll have to deal with several cases for delete such as when a node has children or not). If you need additional resources, check out these two articles on [inserting](https://www.geeksforgeeks.org/binary-search-tree-set-1-search-and-insertion/?ref=lbp) and [deleting](about:blank), or this [video](https://www.youtube.com/watch?v=wcIRPqTR3Kc&feature=youtu.be) with several visual examples.
